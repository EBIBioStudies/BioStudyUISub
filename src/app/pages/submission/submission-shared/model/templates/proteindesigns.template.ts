  ...
  'sectionType': {
    ...
    'fieldTypes': [
      ...
      },
      {
        ...
        'helpText': 'For example "expressed in E. coli", "synthesized chemically", "expressed using yeast surface display"',
        'icon': 'fa-title',
        'display': 'required',
        'valueType': {
          'name': 'largetext',
      ...
      },
      {
        ...
        'helpText': 'Based on whatever test you use to assess the amount of protein produced (e.g. band on a gel, ' +
      ...
      },
      {
        ...
        'helpText': 'Please upload data from whatever test you use. e.g. an image of a protein gel, data from a FACS experient.',
        'icon': 'fa-file',
        'display': 'desirable',
        'valueType': {
          'name': 'file'
      ...
      {
        'name': 'Solubility',
        'helpText': 'Especially relevant for proteins expressed in cells. When you lyse the cell, is the majority of the protein ' +
