export const biaImplicitTemplateV0 = {
  ...
  sectionType: {
    ...
    banner: {
      ...
      contactUs: {
        text:
          'This is the super-user BioImages submission form, intended for minor edits. For significant updates, consider using the REMBI submission generation scripts, or contact ',
