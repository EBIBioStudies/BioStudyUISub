        ...
        tableTypes: [
          {
            name: 'Imaging method',
            icon: '',
            description: 'DUMMY DESCRIPTION Imaging method.',
            uniqueCols: true,
            display: 'required',
            rowAsSection: true,
            columnTypes: [
