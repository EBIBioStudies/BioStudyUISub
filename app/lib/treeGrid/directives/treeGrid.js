import tmpl from './treeGrid.html!ng-template'
...
class TreeGridDirective {
    constructor($timeout) {
        ...
        Object.assign(this, {
            ...
            templateUrl: function (tElement, tAttrs) {
                return tAttrs.templateUrl || tmpl.templateUrl;
            },
            replace: true,
            scope: {
                treeData: '=',
            ...
            link: function (scope, element, attrs) {
                var expandingProperty, expand_all_parents, expand_level, for_all_ancestors, for_each_branch, get_parent, n, on_treeData_change, select_branch, selected_branch, tree;
    ...
    static create($timeout) {
        ...
        return new TreeGridDirective($timeout);
    }
}

export default TreeGridDirective.create;