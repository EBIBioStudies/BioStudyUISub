...
class BsPubMedIdSearchDirective {
    constructor() {
        Object.assign(this, {
            restrict: 'E',
            scope: {
            ...
            controller: BsPubMedIdSearchController
        });
    }

    static create() {
        return new BsPubMedIdSearchDirective();
    }
}

export default BsPubMedIdSearchDirective.create;