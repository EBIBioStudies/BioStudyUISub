...
sed -d 's%"APP_SUPER_USER_USERNAME".*%"APP_SUPER_USER_USERNAME":"'$mainSuperUserUsername'",%' src/config.json
sed -d 's%"APP_ANNOUNCEMENT_HEADLINE".*%"APP_ANNOUNCEMENT_HEADLINE":"'$announcementHeadline'",%' src/config.json
sed -d 's%"APP_ANNOUNCEMENT_CONTENT".*%"APP_ANNOUNCEMENT_CONTENT":"'$announcementContent'",%' src/config.json
sed -d 's%"APP_ANNOUNCEMENT_PRIORITY".*%"APP_ANNOUNCEMENT_PRIORITY":"'$announcementPriority'",%' src/config.json
